...
have_genetic_data = pd.read_csv("data/pluggable/X_temp_earlyfusion.csv")["PATIENT"]
...
for name, df in datasets.items():
    ...
    logits_df.to_csv(f"data/results/logits_{name}_tabPFN_lfscores.csv", index=False)
...
results_df.to_csv("data/results/tabPFN_metrics_lfscores.csv", index=False)